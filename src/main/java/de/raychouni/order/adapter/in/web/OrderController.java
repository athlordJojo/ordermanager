...
public class OrderController {
    ...
    public List<OrderDto> getAllOrders(@PathVariable("companyId") UUID companyId) {
        List<Order> all =
                getAllOrdersForCompanyUseCase.getAllOrdersByCompanyId(
                        new GetAllOrdersForCompanyCommand(companyId));
        return all.stream()
    ...
    public OrderDto createOrder(
            @RequestBody OrderDto orderDto, @PathVariable("companyId") UUID companyId) {
        Order createdOrder =
                createOrderForCompanyUsecase.createOrder(
    ...
    public OrderDto updateOrder(
        ...
        UpdateOrderOfCompanyCommand updateOrderOfCompanyCommand =
                new UpdateOrderOfCompanyCommand(
                        companyId,
                        orderId,
                        orderDto.getScoreBoardNumber(),
    ...
    public ResponseEntity<Void> deleteOrder(
            @PathVariable("companyId") UUID companyId, @PathVariable("orderId") UUID orderId) {
        deleteOrderOfCompanyUseCase.deleteOrderOfCompany(
                new DeleteOrderOfCompanyCommand(companyId, orderId));
