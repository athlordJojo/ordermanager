...
class OrderPersistenceAdapterTest {
    ...
    void deleteOrderOfCompany_withNonExistingEntity_expectException() {
        when(orderRepository.findFirstByUuidAndCompany_Uuid(orderJpa.getUuid(), companyId))
    ...
    void deleteOrderOfCompany_withExistingEntity_expectSuccess() {
        when(orderRepository.findFirstByUuidAndCompany_Uuid(orderJpa.getUuid(), companyId))
                .thenReturn(Optional.of(orderJpa));
    ...
    void updateOrderOfCompany_withExistingCompany() {
        when(orderRepository.findFirstByUuidAndCompany_Uuid(orderId, companyId))
                .thenReturn(Optional.ofNullable(orderJpa));
